...
<head>
  ...
  <meta name="description" content="Politica de privacidade da Munnius: como dados de contato sao usados para responder solicitacoes e respostas." />
...
<body>
<header id="site-header"><a href="/index.html" class="header-logo" aria-label="Munnius"><img src="assets/brand/munnius-logo.png" alt="Munnius" /></a><nav aria-label="Navegacao principal"><a href="/sobre.html">Sobre</a><a href="/servicos.html">Projetos</a><a href="/blog/index.html">Blog</a></nav><a href="/contato.html" class="header-cta">Enviar contexto</a><button class="menu-toggle" aria-label="Abrir menu"><span></span><span></span><span></span></button></header>
<main><section class="section"><div class="container narrow-content"><p class="eyebrow">Privacidade</p><h1>Politica de privacidade</h1><p>A Munnius usa os dados enviados pelo formulario apenas para responder solicitacoes, preparar respostas e manter contato sobre a conversa iniciada pelo visitante.</p><h2>Dados coletados</h2><p>Podem ser coletados nome, empresa, e-mail, telefone, cargo e mensagem enviada voluntariamente pelo formulario de contato.</p><h2>Uso das informacoes</h2><p>As informacoes sao usadas para entender o cenario apresentado, responder a solicitacao e registrar contexto comercial ou consultivo relacionado a Munnius.</p><h2>Compartilhamento</h2><p>A Munnius nao vende dados pessoais. Informacoes podem transitar por servicos necessarios ao funcionamento do formulario e hospedagem do site.</p><h2>Contato</h2><p>Para solicitar ajuste ou remocao de dados, envie um e-mail para <a href="mailto:contato@munnius.com.br">contato@munnius.com.br</a>.</p></div></section></main>
<footer id="site-footer"><div class="footer-top"><div class="footer-brand"><a href="/index.html"><img src="assets/brand/munnius-logo-light.png" alt="Munnius" /></a><p>Projetos remotos e conteudo aplicado sobre IA, onboarding e operacao SaaS.</p></div><div class="footer-links"><div><strong>Site</strong><a href="/sobre.html">Sobre</a><a href="/servicos.html">Projetos</a><a href="/blog/index.html">Blog</a><a href="/contato.html">Contato</a></div><div><strong>Contato</strong><a href="mailto:contato@munnius.com.br">contato@munnius.com.br</a><a href="https://linkedin.com/in/grmunhoz" target="_blank" rel="noreferrer">LinkedIn</a><a href="https://youtube.com/@by.munnius" target="_blank" rel="noreferrer">YouTube</a></div></div></div><div class="footer-bottom"><p>(c) 2026 Munnius. Todos os direitos reservados.</p><p class="footer-legal"><strong>CNPJ:</strong>&nbsp;68.069.326/0001-09</p></div></footer><script src="assets/mobile-menu.js?v=2"></script>
</body></html>
"""
